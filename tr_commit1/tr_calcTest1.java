...
class tr_calcTest1 {
    ...
    @Test
    void get_tr_Lb() {
        System.out.println(Arrays.toString(trt.get_tr_Lb()));
        System.out.println(1.0+6.0/7.0/Math.pow(2,0.5));
    ...
    @Test
    void tr_writer() {
        Assertions.assertEquals("a=3.0; b=5.0; c=4.0; S=6.0; P=12.0; ", trt.tr_writer(("a, b, c, S, P"),"trt.txt"));
    }
}