...
public class tr_calc {
    ...
    tr_calc(String str){
        ...
        /*if ((m!=0)&(n!=0)){ k = Math.PI-m-n;}
        if ((m!=0)&(k!=0)){ n = Math.PI-m-k;}
        if ((n!=0)&(k!=0)){ m = Math.PI-n-k;}*/
        else if ((a!=0)&(m!=0)&(k!=0)){
            n = Math.PI-m-k;
    ...
    double[] get_tr_L(){
        ...
        if (Double.isNaN(x_L)){ x_L = 0;}
        if (Double.isNaN(y_L)){ y_L = 0;}
    ...
    double[] get_tr_Lb(){
        ...
        if (Double.isNaN(x_Lb)){ x_Lb = 0;}
        if (Double.isNaN(y_Lb)){ y_Lb = 0;}
    ...
    double[] get_tr_Lc(){
        ...
        if (Double.isNaN(x_Lc)){ x_Lc = 0;}
        if (Double.isNaN(y_Lc)){ y_Lc = 0;}
    ...
    double[] get_tr_La(){
        ...
        if (Double.isNaN(x_La)){ x_La = 0;}
        if (Double.isNaN(y_La)){ y_La = 0;}
        //System.out.println((x3-x1+y1*(x2-x1)/(y2-y1)-y3*(x3-x_l)/(y3-y_l)));
        //System.out.println()
        //System.out.println(((x2-x1)/(y2-y1)-(x3-x_l)/(y3-y_l)));
    ...
    double[] get_tr_H(){
        ...
        if (Double.isNaN(x_H)){ x_H = 0;}
        if (Double.isNaN(y_H)){ y_H = 0;}
    ...
    double[] get_tr_Hb(){
        ...
        if (Double.isNaN(x_Hb)){ x_Hb = 0;}
        if (Double.isNaN(y_Hb)){ y_Hb = 0;}
    ...
    double[] get_tr_Ha(){
        ...
        if (Double.isNaN(x_Ha)){ x_Ha = 0;}
        if (Double.isNaN(y_Ha)){ y_Ha = 0;}
    ...
    double[] get_tr_Hc(){
        ...
        if (Double.isNaN(x_Hc)){ x_Hc = 0;}
        if (Double.isNaN(y_Hc)){ y_Hc = 0;}
    ...
    double[] get_tr_ob(){
        ...
        if (Double.isNaN(x_ob)){ x_ob = 0;}
        if (Double.isNaN(y_ob)){ y_ob = 0;}
    ...
    double[] get_tr_oa(){
        double x_l = this.get_tr_L()[0];
        double y_l = this.get_tr_L()[1];
        //double x_oa= (y_l-y3+(x1-x3)/(y1-y3)*x_l+(y1-y3)/(x1-x3)*x3)/((x1-x3)/(y1-y3)+(y1-y3)/(x1-x3));
        //double y_oa= (x_l-x3+(y1-y3)/(x1-x3)*y_l+(x1-x3)/(y1-y3)*x3)/((y1-y3)/(x1-x3)+(x1-x3)/(y1-y3));
        ...
        if (Double.isNaN(x_oa)){ x_oa = 0;}
        if (Double.isNaN(y_oa)){ y_oa = 0;}
    ...
    double[] get_tr_oc(){
        double x_l = this.get_tr_L()[0];
        double y_l = this.get_tr_L()[1];
        //double x_oc = (y_l-y1+(x2-x1)/(y2-y1)*x_l+(y2-y1)/(x2-x1)*x1)/((x2-x1)/(y2-y1)+(y2-y1)/(x2-x1));
        //double y_oc= (x_l-x1+(y2-y1)/(x2-x1)*y_l+(x2-x1)/(y2-y1)*x1)/((y2-y1)/(x2-x1)+(x2-x1)/(y2-y1));
        ...
        if (Double.isNaN(x_oc)){ x_oc = 0;}
        if (Double.isNaN(y_oc)){ y_oc = 0;}
    ...
    double[] get_tr_O(){
        ...
        if (Double.isNaN(x_O)){ x_O = 0;}
        if (Double.isNaN(y_O)){ y_O = 0;}
        double[] O = new double[]{x_O, y_O};
        return O;
    }
    String tr_writer(String str2, String path1){
        String str4 = "";
        try {
            ...
            for (String k: str3){
                if (k.equals("a")){
                    str4+="a="+Double.toString(this.get_tr_a())+"; ";
                    //filewriter1.write("a="+Double.toString(this.get_tr_a())+"; ");
                }
                if (k.equals("b")){
                    str4+="b="+Double.toString(this.get_tr_b())+"; ";
                    //filewriter1.write("b="+Double.toString(this.get_tr_b())+"; ");
                }
                if (k.equals("c")){
                    str4+="c="+Double.toString(this.get_tr_c())+"; ";
                    //filewriter1.write("c="+Double.toString(this.get_tr_c())+"; ");
                }
                if (k.equals("m")){
                    str4+="m="+Double.toString(this.get_tr_m())+"; ";
                    //filewriter1.write("m="+Double.toString(this.get_tr_m())+"; ");
                }
                if (k.equals("n")){
                    str4+="n="+Double.toString(this.get_tr_n())+"; ";
                    //filewriter1.write("n="+Double.toString(this.get_tr_n())+"; ");
                }
                if (k.equals("k")){
                    str4+="k="+Double.toString(this.get_tr_k())+"; ";
                    //filewriter1.write("k="+Double.toString(this.get_tr_k())+"; ");
                }
                if (k.equals("R")){
                    str4+="R="+Double.toString(this.get_tr_R())+"; ";
                    //filewriter1.write("R="+Double.toString(this.get_tr_R())+"; ");
                }
                if (k.equals("r")){
                    str4+="r="+Double.toString(this.get_tr_r())+"; ";
                    //filewriter1.write("r="+Double.toString(this.get_tr_r())+"; ");
                ...
                if (k.equals("S")){
                    str4+="S="+Double.toString(this.get_tr_S())+"; ";
                    //filewriter1.write("S="+Double.toString(this.get_tr_S())+"; ");
                }
                if (k.equals("P")){
                    str4+="P="+Double.toString(this.get_tr_P())+"; ";
                    //filewriter1.write("P="+Double.toString(this.get_tr_P())+"; ");
                }
                if (k.equals("A")){
                    str4+="A="+Arrays.toString(this.get_tr_A())+"; ";
                    //filewriter1.write("A="+Arrays.toString(this.get_tr_A())+"; ");
                }
                if (k.equals("B")){
                    str4+="B="+Arrays.toString(this.get_tr_B())+"; ";
                    //filewriter1.write("B="+Arrays.toString(this.get_tr_B())+"; ");
                }
                if (k.equals("C")){
                    str4+="C="+Arrays.toString(this.get_tr_C())+"; ";
                    //filewriter1.write("C="+Arrays.toString(this.get_tr_C())+"; ");
                }
                if (k.equals("M")){
                    str4+="M="+Arrays.toString(this.get_tr_M())+"; ";
                    //filewriter1.write("M="+Arrays.toString(this.get_tr_M())+"; ");
                }
                if (k.equals("Ma")){
                    str4+="Ma="+Arrays.toString(this.get_tr_Ma())+"; ";
                    //filewriter1.write("Ma="+Arrays.toString(this.get_tr_Ma())+"; ");
                }
                if (k.equals("Mb")){
                    str4+="Mb="+Arrays.toString(this.get_tr_Mb())+"; ";
                    //filewriter1.write("Mb="+Arrays.toString(this.get_tr_Mb())+"; ");
                }
                if (k.equals("Mc")){
                    str4+="Mc="+Arrays.toString(this.get_tr_Mc())+"; ";
                    //filewriter1.write("Mc="+Arrays.toString(this.get_tr_Mc())+"; ");
                }
                if (k.equals("L")){
                    str4+="L="+Arrays.toString(this.get_tr_L())+"; ";
                    //filewriter1.write("L="+Arrays.toString(this.get_tr_L())+"; ");
                }
                if (k.equals("La")){
                    str4+="La="+Arrays.toString(this.get_tr_La())+"; ";
                    //filewriter1.write("La="+Arrays.toString(this.get_tr_La())+"; ");
                }
                if (k.equals("Lb")){
                    str4+="Lb="+Arrays.toString(this.get_tr_Lb())+"; ";
                    //filewriter1.write("Lb="+Arrays.toString(this.get_tr_Lb())+"; ");
                }
                if (k.equals("Lc")){
                    str4+="Lc="+Arrays.toString(this.get_tr_Lc())+"; ";
                    //filewriter1.write("Lc="+Arrays.toString(this.get_tr_Lc())+"; ");
                }
                if (k.equals("oa")){
                    str4+="oa="+Arrays.toString(this.get_tr_oa())+"; ";
                    //filewriter1.write("oa="+Arrays.toString(this.get_tr_oa())+"; ");
                }
                if (k.equals("ob")){
                    str4+="ob="+Arrays.toString(this.get_tr_ob())+"; ";
                    //filewriter1.write("ob="+Arrays.toString(this.get_tr_ob())+"; ");
                }
                if (k.equals("oc")){
                    str4+="oc="+Arrays.toString(this.get_tr_oc())+"; ";
                    //filewriter1.write("oc="+Arrays.toString(this.get_tr_oc())+"; ");
                }
                if (k.equals("H")){
                    str4+="H="+Arrays.toString(this.get_tr_H())+"; ";
                    //filewriter1.write("H="+Arrays.toString(this.get_tr_H())+"; ");
                }
                if (k.equals("Ha")){
                    str4+="Ha="+Arrays.toString(this.get_tr_Ha())+"; ";
                    //filewriter1.write("Ha="+Arrays.toString(this.get_tr_Ha())+"; ");
                }
                if (k.equals("Hb")){
                    str4+="Hb="+Arrays.toString(this.get_tr_Hb())+"; ";
                    //filewriter1.write("Hb="+Arrays.toString(this.get_tr_Hb())+"; ");
                }
                if (k.equals("Hc")){
                    str4+="Hc="+Arrays.toString(this.get_tr_Hc())+"; ";
                    //filewriter1.write("Hc="+Arrays.toString(this.get_tr_Hc())+"; ");
                }
                if (k.equals("O")){
                    str4+="O="+Arrays.toString(this.get_tr_O())+"; ";
                    //filewriter1.write("O="+Arrays.toString(this.get_tr_O())+"; ");
                }
            }
            //filewriter1.close();
