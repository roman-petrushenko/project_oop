...
public class CircleController {
    ...
    void setPars1(ActionEvent event) {
        try {
            ...
            CircleOnPane.setCenterX(circle1.getXCenter()/i);
            CircleOnPane.setCenterY(-circle1.getYCenter()/i);
            CircleOnPane.setRadius(R/i);

            CircleCenterOnPane.setCenterX(circle1.getXCenter()/i);
            CircleCenterOnPane.setCenterY(-circle1.getYCenter()/i);
            ...
            circle1.getChords().clear();
            circle1.getSectors().clear();
    ...
    void AddChord(ActionEvent event) {
        try {
            ...
            ChordsList.getItems().clear();
            ChordsList.getItems().addAll(circle1.getChords());
    ...
    void AddSector(ActionEvent event) {
        try {
            ...
            SectorsList.getItems().clear();
            SectorsList.getItems().addAll(circle1.getSectors());
    ...
    void RemoveSector(ActionEvent event) {
        try {
            SectorsGr.getChildren().remove(sectorInd);
    ...
    void calcDistanceBetweenChords(ActionEvent event) {
        try {
            int ch1Ind = Integer.parseInt(ch1.getText())-1;
            int ch2Ind = Integer.parseInt(ch2.getText())-1;
