...
public class Ellipse extends Circle {
    ...
    public void addChord(double x1, double y1, double x2, double y2) {
        if (isOnEllipse(x1, y1) && isOnEllipse(x2, y2)) {
            ...
            throw new IllegalArgumentException("Both points must be on the ellipse to form a chord.");
        }
    }
    ...
    public void updateChord(int index, double x1, double y1, double x2, double y2) {
        if (isOnEllipse(x1, y1) && isOnEllipse(x2, y2)) {
            ...
            throw new IllegalArgumentException("Both points must be on the ellipse to form a valid chord.");
        }
    }
