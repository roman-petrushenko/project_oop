package com.example.hell.squrcontroller;
    ...
    quad_calc(String s1){
        ...
        for (String i: s2){
            if (i.charAt(0)=='a'){
                ...
                throw new InputMismatchException("Exception for:"+i.charAt(0));
            }
        }
        if ((a!=0)&(b!=0)&(d!=0)&(m!=0)&(n!=0)){
            ...
            throw new InputMismatchException("Not enough values (of the blueprint) to fully determine quadrilateral");
        }
