...
public class Parabola implements IConicSection{

    @Override
    public double[] Focus() {
        double x = isVertical ? -b / (2 * a) : 0;
        double y = isVertical ? (1 - (b * b) / (4 * a)) / a : 0;
        return new double[]{x, y};
    }

    @Override
    public double[] Directrix() {
        double directrixY = isVertical ? (b * b - 1) / (4 * a) : 0;
        return new double[]{0, directrixY};
    }
