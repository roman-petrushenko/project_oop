...
public class Hyperbola implements IConicSection, IConicCalculations {
    private double h;
    private double k;
    private double a;
    private double b;
    @Override
    public double[] Focus() {
        double fociDistance = Math.sqrt(a * a + b * b);
        return new double[]{h + fociDistance, k, h - fociDistance, k};
    }

    @Override
    public double[] Directrix() {
        double directrixDistance = a * a / Math.sqrt(a * a + b * b);
        return new double[]{h + directrixDistance, h - directrixDistance};
    }
