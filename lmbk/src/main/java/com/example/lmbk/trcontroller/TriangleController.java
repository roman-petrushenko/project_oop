...
public class TriangleController {
    ...
    public void setStage_tr(Stage stage) {
        this.stage = stage;
    }

    @FXML
    private void openNewStage_tr() {
        if (stage != null) {
    ...
    @FXML
    private Button back_tr;


    @FXML
    void return_tr(ActionEvent event) {
        TrianglePane.getScene().getWindow().hide();
