package com.example.lmbk.trcontroller;
...
//            System.out.println("Exception for input data:"+exc);
    ...
    public double[] get_tr_L(){
        ...
        double x_l1 = (y1 -y2 +x2*Math.tan((t+g)/2) -x1*Math.tan((t+f)/2))/(Math.tan((t+g)/2) - Math.tan((t+f)/2));
        double y_l1 = (x1 -x2 +y2/Math.tan((t+g)/2) -y1/Math.tan((t+f)/2))/(1/Math.tan((t+g)/2) - 1/Math.tan((t+f)/2));
        double x_l2 = (y1 -y2 +x2*Math.tan((t+g)/2+Math.PI/2) -x1*Math.tan((t+f)/2))/(Math.tan((t+g)/2+Math.PI/2) - Math.tan((t+f)/2));
        double y_l2 = (x1 -x2 +y2/Math.tan((t+g)/2+Math.PI/2) -y1/Math.tan((t+f)/2))/(1/Math.tan((t+g)/2+Math.PI/2) - 1/Math.tan((t+f)/2));
        double x_l3 = (y1 -y2 +x2*Math.tan((t+g)/2+Math.PI/2) -x1*Math.tan((t+f)/2+Math.PI/2))/(Math.tan((t+g)/2+Math.PI/2) - Math.tan((t+f)/2+Math.PI/2));
        double y_l3 = (x1 -x2 +y2/Math.tan((t+g)/2+Math.PI/2) -y1/Math.tan((t+f)/2+Math.PI/2))/(1/Math.tan((t+g)/2+Math.PI/2) - 1/Math.tan((t+f)/2+Math.PI/2));
        double x_l4 = (y1 -y2 +x2*Math.tan((t+g)/2) -x1*Math.tan((t+f)/2+Math.PI/2))/(Math.tan((t+g)/2) - Math.tan((t+f)/2+Math.PI/2));
        double y_l4 = (x1 -x2 +y2/Math.tan((t+g)/2) -y1/Math.tan((t+f)/2+Math.PI/2))/(1/Math.tan((t+g)/2) - 1/Math.tan((t+f)/2+Math.PI/2));
        ...
        /*if (Math.tan((t+g)/2)<0){
        x_L = (y1 -y2 +x2*Math.tan((t+g)/2) -x1*Math.tan((t+f)/2))/(Math.tan((t+g)/2) - Math.tan((t+f)/2));
        y_L = (x1 -x2 +y2/Math.tan((t+g)/2) -y1/Math.tan((t+f)/2))/(1/Math.tan((t+g)/2) - 1/Math.tan((t+f)/2));}
        else{
            x_L = (y1 -y2 +x2*Math.tan((t+g)/2+Math.PI/2) -x1*Math.tan((t+f)/2))/(Math.tan((t+g)/2+Math.PI/2) - Math.tan((t+f)/2));
            y_L = (x1 -x2 +y2/Math.tan((t+g)/2+Math.PI/2) -y1/Math.tan((t+f)/2))/(1/Math.tan((t+g)/2+Math.PI/2) - 1/Math.tan((t+f)/2));
        }*/
    ...
    public double[] get_tr_Lc(){
        ...
        double y_Lc=((x2-x3)*(y1-y3)*(y2-y_l)+y3*(x1-x3)*(y2-y_l)-y2*(x2-x_l)*(y1-y3))/((x1-x3)*(y2-y_l)-(x2-x_l)*(y1-y3));
    ...
    public double[] get_tr_H(){
        double x_H= ((y2-y1)*(y3-y1)*(y3-y2) +x2*(x3-x1)*(y3-y2)-x1*(x3-x2)*(y3-y1))/((x3-x1)*(y3-y2)-(x3-x2)*(y3-y1));
    ...
    public double[] get_tr_Ha(){
        double x_Ha=((y3-y1)*(y2-y1)*(x2-x1)+x3*(x2-x1)*(x2-x1)+x1*(y2-y1)*(y2-y1))/((y2-y1)*(y2-y1)+(x2-x1)*(x2-x1));
        double y_Ha= ((x3-x1)*(x2-x1)*(y2-y1)+y3*(y2-y1)*(y2-y1)+y1*(x2-x1)*(x2-x1))/((x2-x1)*(x2-x1)+(y2-y1)*(y2-y1));

        double[] Ha = new double[]{x_Ha, y_Ha};
        return Ha;
    }
    public double[] get_tr_Hc(){
        double x_Hc=((y2-y3)*(y1-y3)*(x1-x3)+x2*(x1-x3)*(x1-x3)+x3*(y1-y3)*(y1-y3))/((y1-y3)*(y1-y3)+(x1-x3)*(x1-x3));
        double y_Hc= ((x2-x3)*(x1-x3)*(y1-y3)+y2*(y1-y3)*(y1-y3)+y3*(x1-x3)*(x1-x3))/((x1-x3)*(x1-x3)+(y1-y3)*(y1-y3));
    ...
    public double[] get_tr_oa(){
        ...
        double x_oa = ((y_l-y1)*(y2-y1)*(x2-x1)+(x2-x1)*(x2-x1)*x_l+(y2-y1)*(y2-y1)*x1)/((x2-x1)*(x2-x1)+(y2-y1)*(y2-y1));
    ...
    public String tr_writer(String str2,int k1) {
        String str4 = "";
        ...
        try {
            ...
            for (String k: str3){
                ...
                if (k.equals("o")){
                    str4+="o="+Arrays.toString(round_val(this.get_tr_L(),k1))+"; ";
